...
const services: Service[] = [
  {
    ...
    preview: 'Technical SEO, high-intent content, and local relevance signals to drive organic visibility across the UAE.',
    icon: Search,
  },
  {
    name: 'Google Ads Management',
    description: 'Performance-driven paid campaigns',
    preview: 'High-ROI Google Ads across Search, YouTube, Display, and remarketing built for Dubai businesses.',
    icon: MousePointerClick,
  },
  {
    name: 'Social Media Marketing',
    description: 'Strategic social presence across platforms',
    preview: 'Social strategy and influencer campaigns for Dubai audiences on Instagram, TikTok, YouTube, and LinkedIn.',
    icon: Share2,
  },
  {
    name: 'AI Content Systems',
    description: 'AI-powered content generation',
    preview: 'Scalable AI-driven content production with authority positioning and modern discovery optimization.',
    icon: Sparkles,
  },
  {
    name: 'Web Development',
    description: 'High-converting web experiences',
    preview: 'Premium web development with conversion optimization and performance-first architecture.',
    icon: Globe,
  },
  {
    name: 'Answer Engine Optimization',
    description: 'Optimize for AI search engines',
    preview: 'Position your brand in AI-driven search results like ChatGPT, Gemini, and Perplexity.',
    icon: Brain,
  },
  {
    name: 'Creative Production',
    description: 'Premium visual content production',
    preview: 'Premium video, short-form creative, and AI avatars designed for authority and engagement.',
    icon: Video,
  },
  {
    name: 'Conversion Strategy',
    description: 'Conversion rate optimization systems',
    preview: 'Data-driven conversion optimization to maximize revenue from existing traffic and campaigns.',
    icon: BarChart3,
  },
];
      ...
      <div className="max-w-[1100px] mx-auto relative z-10 w-full">
        ...
        >
          ...
          <p className="text-xl lg:text-2xl text-[#D4DBE8] max-w-3xl mx-auto leading-relaxed">
            We help companies in Dubai grow through SEO, Google Ads, social media, AI content, and conversion systems, engineered for serious markets across the UAE.
          </p>
        </motion.div>
          ...
          <div className="relative bg-black/40 backdrop-blur-xl rounded-[32px] p-8 md:p-12 lg:p-16 border border-white/10">
            ...
            <div className="relative z-10">
              ...
              <p className="text-base md:text-lg lg:text-xl text-[#D4DBE8] mb-8 md:mb-10 leading-relaxed max-w-3xl">
                Mélange Digital supports Dubai businesses with full-spectrum marketing, SEO, paid search, social media strategy, AI-driven content, and high-converting web experiences. From visibility to demand capture, we build structured growth systems designed to help brands compete and win in Dubai's most competitive industries.
              </p>
              ...
              <div className="hidden lg:block mb-10">
                ...
                >
                  {/* 2-Row Service Grid */}
                  <div className="grid grid-cols-4 gap-4 p-6 rounded-2xl"
                    style={{
                      background: 'linear-gradient(135deg, rgba(11, 11, 18, 0.6), rgba(15, 23, 42, 0.5))',
                        ...
                        >
                          ...
                          >
                            ...
                            <motion.div
                              ...
                              style={{
                                background: 'radial-gradient(circle at 50% 50%, rgba(127, 78, 255, 0.2), transparent 70%)',
                              }}
                              animate={{
                            ...
                            <AnimatePresence>
                              {isActive && (
                                <motion.div
                                  className="absolute inset-0 rounded-xl pointer-events-none"
                                  style={{
                                    background: 'radial-gradient(circle at 50% 0%, rgba(213, 64, 255, 0.15), transparent 60%)',
                                  }}
                                  initial={{ opacity: 0 }}
                                  animate={{ opacity: 1 }}
                                  exit={{ opacity: 0 }}
                ...
                <AnimatePresence mode="wait">
                  <motion.div
                    ...
                    style={{
                      background: 'linear-gradient(135deg, rgba(11, 11, 18, 0.4), rgba(15, 23, 42, 0.3))',
                            ...
                            <AnimatePresence>
                              {isExpanded && (
                                <motion.div
                                  className="absolute inset-0 rounded-xl pointer-events-none"
                                  style={{
                                    background: 'linear-gradient(90deg, rgba(213, 64, 255, 0.3) 0%, transparent 50%, rgba(56, 88, 255, 0.3) 100%)',
                                  }}
                                  initial={{ opacity: 0 }}
                                  animate={{ opacity: 1 }}
                                  exit={{ opacity: 0 }}
                            ...
                            <div className="relative flex items-center gap-4">
                              ...
                              <div className="flex-1">
                                ...
                                <div 
                                  ...
                                  style={{
                                    color: isExpanded ? 'rgba(212, 219, 232, 0.7)' : 'rgba(212, 219, 232, 0.5)',
                                  }}
                                >
                                  {service.description}
                                </div>
                          ...
                          {isExpanded && (
                            ...
                            >
                              <div 
                                ...
                                style={{
                                  background: 'linear-gradient(135deg, rgba(11, 11, 18, 0.6), rgba(15, 23, 42, 0.4))',
                                  border: '1px solid rgba(127, 78, 255, 0.2)',
                                }}
                              >
                                <p className="text-sm text-[#D4DBE8]/80 leading-relaxed">
